...
class srcApp_KernelDevDebugContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function __construct(RequestContext $context)
    {
        ...
        $this->staticRoutes = [
            '/projects' => [[['_route' => 'projets', '_controller' => 'App\\Controller\\PortfolioController::index'], null, null, null, false, false, null]],
            '/' => [[['_route' => 'home', '_controller' => 'App\\Controller\\PortfolioController::home'], null, null, null, false, false, null]],
            '/projet/new' => [[['_route' => 'addNew', '_controller' => 'App\\Controller\\PortfolioController::formProject'], null, null, null, false, false, null]],
            '/admin' => [[['_route' => 'admin', '_controller' => 'App\\Controller\\PortfolioController::admin'], null, null, null, false, false, null]],
            '/moi' => [[['_route' => 'profile', '_controller' => 'App\\Controller\\PortfolioController::profile'], null, null, null, false, false, null]],
            ...
            '/project' => [[['_route' => 'index', '_controller' => 'App\\Controller\\Project::project'], null, null, null, false, false, null]],
            '/step2' => [[['_route' => 'step2', '_controller' => 'App\\Controller\\Project::step2'], null, null, null, false, false, null]],
        ];
        $this->regexpList = [
            0 => '{^(?'
                    .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
        ...
        $this->dynamicRoutes = [
            ...
            100 => [[['_route' => 'fos_user_resetting_reset', '_controller' => 'fos_user.resetting.controller:resetAction'], ['token'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        ];
    }
}
