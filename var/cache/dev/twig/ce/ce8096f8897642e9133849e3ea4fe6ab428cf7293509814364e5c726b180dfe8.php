...
class __TwigTemplate_9c1cdf893b4d9ece2f156afb5fbcfa228b9d2bc7353397d83ffbcf1ade27b149 extends \Twig\Template
{
    private $source;
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/home/romain-simplon/Git/Symfony/your-project/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
