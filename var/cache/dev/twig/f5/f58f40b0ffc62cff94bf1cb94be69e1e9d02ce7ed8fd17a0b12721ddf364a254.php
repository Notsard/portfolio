...
class __TwigTemplate_2410b888d1cea385caf269ca8f93f9bc441e9d782b3111acdd4ca9a307412084 extends \Twig\Template
{
    private $source;
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/home/romain-simplon/Git/Symfony/your-project/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
